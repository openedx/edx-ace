...
class TestBrazeClient(TestCase):
    ...
    @override_settings(EDX_BRAZE_API_KEY=API_KEY)
    @patch('edx_ace.utils.braze.BrazeClient')
    ...
    @override_settings(EDX_BRAZE_API_SERVER=API_KEY)
    @patch('edx_ace.utils.braze.BrazeClient')
    ...
    @override_settings(EDX_BRAZE_API_SERVER=API_KEY, EDX_BRAZE_API_KEY=API_KEY)
