...
"""
edx-ace documentation build configuration file.
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Framework for Messaging',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_ace'),
                os.path.join(root_path, 'edx_ace/migrations')])
